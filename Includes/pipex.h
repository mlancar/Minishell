...
/*   Updated: 2023/10/03 13:02:08 by malancar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//int		init_struct(t_pipex *pipex_cmd, int ac);
...
void	exec_pipex_cmd(t_lst_cmd *cmd, int fd_in, int fd_out, int fd_other, t_pipex *pipex_cmd);
